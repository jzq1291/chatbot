-- 清空现有数据
DELETE FROM chatbot.knowledge_base;

-- 重置序列
ALTER SEQUENCE chatbot.knowledge_base_id_seq RESTART WITH 1;

-- 插入产品使用说明
INSERT INTO chatbot.knowledge_base (title, content, category, created_at, updated_at) VALUES
('产品安装指南', '1. 下载安装包
2. 双击安装文件
3. 按照安装向导完成安装
4. 首次启动需要进行初始化设置
